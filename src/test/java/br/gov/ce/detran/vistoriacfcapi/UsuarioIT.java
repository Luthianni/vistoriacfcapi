...
import br.gov.ce.detran.vistoriacfcapi.web.dto.UsuarioSenhaDto;
...
public class UsuarioIT {
        ...
        public void createUsuario_ComUsernameEPasswordValidos_RetornarUsuarioCriadoComStatus201() {
                UsuarioResponseDto responseBody = testClient
                                ...
                                .bodyValue(new UsuarioCreateDto("kelly@gmail.com", "123456"))
                                .exchange()
                ...
                org.assertj.core.api.Assertions.assertThat(responseBody.getUsername()).isEqualTo("kelly@gmail.com");
        ...
        public void createUsuario_ComUsernameInvalido_RetornarErrorMessageStatus422() {
                ...
                responseBody = testClient
                                ...
                                .uri("/api/v1/usuarios")
                                .contentType(MediaType.APPLICATION_JSON)
                                .bodyValue(new UsuarioCreateDto("kelly@gmail.", "123456"))
                                .exchange()
                                .expectStatus().isEqualTo(422)
                                .expectBody(ErrorMessage.class)
                                .returnResult().getResponseBody();
        ...
        public void createUsuario_ComPasswordInvalido_RetornarErrorMessageStatus422() {
                ErrorMessage responseBody = testClient
                                ...
                                .uri("/api/v1/usuarios")
                                .contentType(MediaType.APPLICATION_JSON)
                                .bodyValue(new UsuarioCreateDto("kelly@gmail.com", ""))
                                .exchange()
                                .expectStatus().isEqualTo(422)
                                .expectBody(ErrorMessage.class)
                                .returnResult().getResponseBody();
                ...
                responseBody = testClient
                                ...
                                .uri("/api/v1/usuarios")
                                .contentType(MediaType.APPLICATION_JSON)
                                .bodyValue(new UsuarioCreateDto("kelly@gmail.com", "1234"))
                                .exchange()
                                .expectStatus().isEqualTo(422)
                                .expectBody(ErrorMessage.class)
                                .returnResult().getResponseBody();
                ...
                responseBody = testClient
                                ...
                                .uri("/api/v1/usuarios")
                                .contentType(MediaType.APPLICATION_JSON)
                                .bodyValue(new UsuarioCreateDto("kelly@gmail.com", "12345678"))
                                .exchange()
                                .expectStatus().isEqualTo(422)
                                .expectBody(ErrorMessage.class)
                                .returnResult().getResponseBody();
        ...
        public void buscarUsuario_ComIdExistente_RetornarUsuarioComStatus200() {
                UsuarioResponseDto responseBody = testClient
                                ...
                                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "luthianni@gmail.com",
                                                "123456"))
                                .exchange()
                                .expectStatus().isOk()
                                .expectBody(UsuarioResponseDto.class)
                ...
                org.assertj.core.api.Assertions.assertThat(responseBody.getUsername()).isEqualTo("luthianni@gmail.com");
                ...
                responseBody = testClient
                                .get()
                                .uri("/api/v1/usuarios/101")
                                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "kelly@gmail.com",
                                                "123456"))
                                .exchange()
                                .expectStatus().isOk()
                                .expectBody(UsuarioResponseDto.class)
        ...
        @Test
        public void editarSenha_ComUsuariosDiferentes_RetornarUsuarioCriadoComStatus403() {
                ErrorMessage responseBody = testClient
                                .patch()
                                .uri("/api/v1/usuarios/0")
                                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "luthianni@gmail.com",
        ...
        public void editarSenha_ComCamposInvalidos_RetornarErrorMessageStatus422() {
                ...
                responseBody = testClient
                                .patch()
                                .uri("/api/v1/usuarios/101")
                                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "emanuel@gmail.com",
                                                "123456"))
                                .contentType(MediaType.APPLICATION_JSON)
        ...
        @Test
        public void editarSenha_ComCamposInvalidos_RetornarErrorMessageStatus400() {
                ErrorMessage responseBody = testClient
                                .patch()
                                .uri("/api/v1/usuarios/100")
                                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "luthianni@gmail.com",
        ...
        public void listarUsuarios_ComUsuarioComPermissao_RetornarListaDeUsuariosComStatus200() {
                List<UsuarioResponseDto> responseBody = testClient
                                .get()
                                .uri("/api/v1/usuarios")
                                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "luthianni@email.com",
                                                "123456"))
                                .exchange()
                                .expectStatus().isOk()
