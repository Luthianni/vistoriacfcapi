...
import br.gov.ce.detran.vistoriacfcapi.jwt.JwtAuthenticationEntryPoint;
import br.gov.ce.detran.vistoriacfcapi.jwt.JwtAuthorizationFilter;
...
public class SpringSecurityConfig {
    ...
    private static final String[] DOCUMENTATION_OPENAPI = {
        "/docs/index.html",
        "/docs-vistoriacfcapi.html", "/docs-vistoriacfcapi/**",
        "/v3/api-docs/**",
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth                        
                        ...
                        .requestMatchers(HttpMethod.GET, "centroFormacaoCondutores/cnpj/**").authenticated()
